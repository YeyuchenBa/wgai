...
==> subTables[0]  [in template "inner-table\\onetomany\\java\\${bussiPackage}\\${entityPackage}\\vue3\\components\\${entityName}Form.vuei" at line 59, column 30]
...
FTL stack trace ("~" means nesting-related):
	- Failed at: ${subTables[0].entityName?uncap_first}  [in template "inner-table\\onetomany\\java\\${bussiPackage}\\${entityPackage}\\vue3\\components\\${entityName}Form.vuei" at line 59, column 28]
----
