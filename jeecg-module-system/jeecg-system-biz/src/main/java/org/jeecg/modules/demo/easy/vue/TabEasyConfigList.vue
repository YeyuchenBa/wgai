  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'confName',text:'任务名称',dictCode:''})
        fieldList.push({type:'int',value:'typeNum',text:'训练种类',dictCode:''})
        fieldList.push({type:'int',value:'boxSize',text:'训练物体大小px',dictCode:''})
        fieldList.push({type:'int',value:'picNum',text:'图片数量',dictCode:''})
        fieldList.push({type:'double',value:'pth',text:'可信阈值',dictCode:''})
        fieldList.push({type:'string',value:'backUrl',text:'背景图片',dictCode:''})
        fieldList.push({type:'string',value:'logStatic',text:'是否训练日志',dictCode:''})
        fieldList.push({type:'string',value:'status',text:'任务状态',dictCode:''})
        fieldList.push({type:'popup',value:'picList',text:'绑定训练图片', popup:{code:'',field:'',orgFields:'',destFields:''}})
        fieldList.push({type:'list_multi',value:'picTypeId',text:'类别',dictTable:"", dictText:'', dictCode:''})
