...
@Slf4j
public class VideoReadInfo implements Runnable{
    ...
    public VideoReadInfo(String videoUrl, RedisTemplate redisTemplate, String userId, String namesUrl, String cfgUrl, String weightUrl, WebSocket webSocket){
