    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="模型训练日志" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="modelLog">
              <a-input v-model="model.modelLog" placeholder="请输入模型训练日志"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/chat/tabMessageTrainLog/add",
          edit: "/chat/tabMessageTrainLog/edit",
          queryById: "/chat/tabMessageTrainLog/queryById"
        }
      }
    },
    computed: {
